                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: Text("Order No:",overflow:TextOverflow.ellipsis,softWrap: true,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 15.sp),)),
                        ...
                        children: [
                          ...
                          decoration: BoxDecoration(
                            ...
                            child:  Center(child: Padding(
                              ...
                              child: Text("Paid",style: TextStyle(color: Colors.white,fontSize: 12.sp,fontWeight: FontWeight.bold),),
                            )),
                          ),
                          20.w.sw,
                          GestureDetector(
