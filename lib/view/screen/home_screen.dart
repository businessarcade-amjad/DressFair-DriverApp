        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5.h),
                          Text(
                            loginController.profile.value?.shippingProviderId
                                    .toString() ??
                                "",
                            style: TextStyle(
                              fontSize: 16.sp,
                    ...
                    Positioned(
                      ...
                      child: FeatureCards(
                        text1: 'PICKUP',
                        icon1: AppImages.pickupIcon,
                        text2: 'PENDING',
                        icon2: AppImages.pendingIcon,
                        onTap1: () {
              ...
              FeatureCards(
                text1: "OFD",
                icon1: AppImages.ofdIcon,
                text2: 'DELIVERED',
                icon2: AppImages.deliveredIcon,
                onTap1: () {
              ...
              FeatureCards(
                text1: "TO RETURN",
                icon1: AppImages.returnedIcon,
                text2: 'Finance',
                icon2: AppImages.finance,
                onTap1: () {
                  Get.toNamed(returnedScreenMain);
                },
                onTap2: () {
                  Get.toNamed(financeMainScreen);
                },
              ...
              FeatureCards(
                ...
                icon1: AppImages.returnedIcon,
                text2: 'RETURNED',
                icon2: AppImages.returnedIcon,
                onTap1: () {
                  Get.toNamed(rtsMainScreen);
                },
                onTap2: () {
                  //Get.toNamed(returnedScreenMain);
                },
        ...
        child: Row(
          ...
          children: [
            ...
            Visibility(
              ...
              child: Container(height: 130.h, width: 110.w),
            ),
            Visibility(
              visible: isShowSecondCard,
